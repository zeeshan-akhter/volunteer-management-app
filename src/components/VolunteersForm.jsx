    ...
    <form onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <input
          type="checkbox"
          name="availability"
          checked={volunteerData.availability === true ? "on" : ""}
          onChange={handleChange}
        />
      </div>
      ...
      <div>
        ...
        <textarea
          onChange={handleChange}
          value={volunteerData.areasOfInterest.join(",")}
          name="areasOfInterest"
          id=""
          cols="20"
          rows="2"
          placeholder="Interests should be separated by comma"
        />
      </div>
      <div>
        <MultipleSelectCheckmarks
          preData={volunteerData}
          handleChangeFunction={setvolunteerData}
        />
      </div>
